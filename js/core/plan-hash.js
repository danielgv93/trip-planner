...
export function canonicalPlanJson(value) {
    return JSON.stringify(stableValue(normalizePortablePlan(value)));
}

// Small synchronous SHA-256 implementation so this module behaves identically
// in native browser modules and Node without importing an environment API.
...
export function canonicalPlanHash(value) {
    return sha256(canonicalPlanJson(value));
}
